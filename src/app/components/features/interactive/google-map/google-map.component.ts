import { Component, OnInit, Input, ViewChild, EventEmitter, Output,
...
export class GoogleMapComponent extends ForceUpdatableComponent implements OnInit, OnDestroy {
  [x: string]: any;
